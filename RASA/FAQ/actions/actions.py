...
score_threshold = 0.90  # This confidence scores can be adjusted based on your need!!
...
class ActionGetFAQAnswer(Action):
    ...
    def __init__(self):
        ...
        self.standard_questions_encoder = np.load("./data/questions_embedding.npy")
        self.standard_questions_encoder_len = np.load("./data/questions_embedding_len.npy")
...
def encode_standard_question(sentence_transformer_select=True, pretrained_model='bert-base-nli-mean-tokens'):
    ...
    np.save("./data/questions_embedding", standard_questions_encoder)
    standard_questions_encoder_len = np.sqrt(np.sum(standard_questions_encoder * standard_questions_encoder, axis=1))
    np.save("./data/questions_embedding_len", standard_questions_encoder_len)
